...
<form method="post">
	...
	<div class="input-control select full-size">
		<select name="kriteria">
			<option value="<?php echo isset($_GET['kriteria']) ? $_GET['kriteria'] : ''; ?>"><?php echo isset($_GET['kriteria']) ? GetNameKriteria($db, $_GET['kriteria']) : ''; ?></option>
			<?php
				...
				<tr>
					...
					<td>
						...
						?>
							...
							<a href="?page=hapus&id=<?php echo $row2['id_sub_kriteria'] ?> &kriteria=<?= $row["id_kriteria"] ?>" style="color:red;"><span class="mif-cancel icon"></span></a><br />
						<?php
						}
						?>
					</td>
